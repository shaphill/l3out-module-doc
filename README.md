...
| <span id="input_default_route_leak_policy">[default\_route\_leak\_policy](#input\_default\_route\_leak\_policy)</a>  <br> Route Profile for Interleak Policy | <pre>object({<br>    criteria = optional(string)<br>    always   = optional(string)<br>    scope    = optional(list(string))<br>    }<br>  )</pre> | `null` | no |
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMzOTk3OTE2OCwtNTM5NjI2MTkzLDE4MD
M1Nzg2NSwtMTY2OTIxNTYwOCwtNzYzNDE3MTk5LDE0NDM2MDQz
NDNdfQ==
-->