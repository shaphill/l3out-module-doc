...
```
Next, because we are configuring vPCs, we will use the vPC variable block to define all of our interface and node policies.
```
  vpcs  =  [
  {
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4NzcxMjMyNjQsODQ5ODAxNzgyLC0xMj
