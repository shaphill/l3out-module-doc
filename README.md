...
```
Next, because we are configuring vPCs, we will use the [vPCs](#input\_vpcs) variable block to define all of our interface and node profiles, including our SVI configuration. We leave the `ospf_interface_profile` blank to pass in an empty interface policy. If you want to a specific OSPF interface policy, you must create the [aci_ospf_interface_policy]() resource outside of the module and reference it in the `ospf_interface_profile` block as 
```
  vpcs  =  [
    {
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwNzQ5Njc3ODgsODQ5ODAxNzgyLC0xMj
IyMjM5MTIxLC01MzYxMjc3NSwtMTQyMDU5MDU3NCwtNDE2NzA5
MjI0LDgwNjg0MTk3OCwxNzQ4ODY5MTkyLC0yMTQwNDI2NTYzLD
gwNzY3NTY5LDE2ODg0OTg4MjYsLTE2NDUxOTExNzcsMTE2NTYx
MTMwOCwxMjY5OTk5MzMyLC01Mzk2MjYxOTMsMTgwMzU3ODY1LC
0xNjY5MjE1NjA4LC03NjM0MTcxOTksMTQ0MzYwNDM0M119
-->